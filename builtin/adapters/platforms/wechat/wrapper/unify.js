...
if (window.__globalAdapter) {
    ...
    if (wx.onWindowResize) {
        wx.onWindowResize(function () {
            ...
            window.canvasPosition.width = window.innerWidth;
            window.canvasPosition.height = window.innerHeight;
      
            window.canvasRect.width = window.innerWidth;
            window.canvasRect.height = window.innerHeight;
